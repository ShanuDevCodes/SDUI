 ...
 */
public val LocalSduiActionHandler: ProvidableCompositionLocal<(SduiActionDto) -> Unit> = staticCompositionLocalOf<(SduiActionDto) -> Unit> {
    { _ -> }
}
 ...
 */
internal val LocalSduiDepth = staticCompositionLocalOf { 0 }
